...
* get请求，获取活动详情
*/
export const getActivityDetails = (data, id) => http.get(`/prod-api/api/activity/activity/${id}`, data)

/**
* get请求，获取活动分类
*/
export const getActivityCategory = (data) => http.get('/prod-api/api/activity/category/list', data)
...
* get请求，分类获取公益活动
*/
export const getWelfareActivityList = (data) => http.get('/prod-api/api/public-welfare/public-welfare-activity/list', data)

/**
* get请求，获取推荐公益活动
*/
export const getWelfareRecommendActivityList = (data) => http.get('/prod-api/api/public-welfare/public-welfare-activity/recommend-list', data)
...
* get请求，获取实践活动详情
*/
export const getVolunteerActivityDetails = (data, id) => http.get('/prod-api/api/volunteer-service/activity/' + id, data);
...
* get请求，获取当前用户活动列表
*/
export const getVolunteerMyActivity = (data, state) => http.get('/prod-api/api/volunteer-service/activity/my-list/' + state, data);
